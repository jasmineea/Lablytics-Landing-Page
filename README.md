...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="../assets/img/favicons/chemistry.png">
    <link rel="icon" type="image/png" sizes="16x16" href="../assets/img/favicons/chemistry.png">
    <link rel="shortcut icon" type="image/x-icon" href="../assets/img/favicons/chemistry.png">
    <link rel="manifest" href="../assets/img/favicons/manifest.json">
    <meta name="msapplication-TileImage" content="../assets/img/favicons/chemistry.png">
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-standard navbar-expand-lg fixed-top navbar-dark" data-navbar-darken-on-scroll="data-navbar-darken-on-scroll">
        <div class="container"><a class="navbar-brand" href="../index.html"><span class="text-white dark__text-white">Lablytics</span></a>
          ...
          <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
            <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
              <li class="nav-item dropdown"><a class="nav-link" href="#about" role="button" >About</a>
              </li>
              <li class="nav-item dropdown"><a class="nav-link" href="#services" role="button">Our Process</a>
              </li>
              
            </ul>
            <ul class="navbar-nav ms-auto">
              <li class="nav-item"><a class="nav-link" href="#!" data-bs-toggle="modal" data-bs-target="#exampleModal">Contact</a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <section class="py-0 overflow-hidden light" id="banner">
        ...
        <div class="bg-holder overlay" style="background-color: #00D37B;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          <div class="row flex-center pt-8 pt-lg-10 pb-lg-9 pb-xl-0">
            <div class="col-md-11 col-lg-8 col-xl-4 pb-7 pb-xl-9 text-center text-xl-start">
              <h1 class="text-white fw-light">Bring <span class="typed-text fw-bold" data-typed-text='["insight","perfomance","analytics"]'></span><br />to your business.</h1>
              <p class="lead text-white opacity-75">With the power of Lablytics, we help you focus on the data that matters!</p>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section style="background-color: white;">
        ...
        <div class="container">
          <div id="about" class="row justify-content-center text-center">
            <div class="col-lg-8 col-xl-7 col-xxl-6">
              <h1 class="fs-2 fs-sm-4 fs-md-5">Grow your business to the next level</h1>
              <p class="lead">At Lablytics we solve data challenges to help optimize marketing campaigns, improve customer experience, increase competitive advantage, and, ultimately, grow your business.</p>
            </div>
          </div>
          <div class="row flex-center mt-8">
            <div class="col-md col-lg-5 col-xl-4 ps-lg-6"><img class="img-fluid px-6 px-md-0" src="../assets/img/icons/black-lightbulb-creativity-symbol(1).png" alt="" style="height: 200px;"/></div>
            <div class="col-md col-lg-5 col-xl-4 mt-4 mt-md-0">
              <h5 class="text-danger"><span class="far fa-lightbulb me-2"></span>PLAN</h5>
              <h3>Data Analysis </h3>
              <p>We will sit down with you to learn about your unique business goals and begin the analysis process.</p>
            </div>
          </div>
          <div class="row flex-center mt-7">
            <div class="col-md col-lg-5 col-xl-4 pe-lg-6 order-md-2"><img class="img-fluid px-6 px-md-0" src="../assets/img/icons/administration.png" alt="" style="height: 200px;" /></div>
            <div class="col-md col-lg-5 col-xl-4 mt-4 mt-md-0">
              <h5 class="text-info"> <span class="far fa-object-ungroup me-2"></span>BUILD</h5>
              <h3>Execution</h3>
              <p>Once we obtain a full picture of your business goals, we'll work with you to form the proper strategy and make the necessary recommendations to get your business moving in the right direction.</p>
            </div>
          </div>
          <div class="row flex-center mt-7">
            <div class="col-md col-lg-5 col-xl-4 ps-lg-6"><img class="img-fluid px-6 px-md-0" src="../assets/img/icons/shuttle.png" alt="" style="height: 200px;" /></div>
            <div class="col-md col-lg-5 col-xl-4 mt-4 mt-md-0">
              <h5 class="text-success"><span class="far fa-paper-plane me-2"></span>DEPLOY</h5>
              <h3>Growth & Scale</h3>
              <p>We’ll work with you to build a proprietary Growth Scorecard that tracks the metrics that matter, and highlights all the hidden opportunities for growth.</p>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <section class="bg-light text-center">
        ...
        <div id="services"class="container">
          <div class="row">
            <div class="col">
              <h1 class="fs-2 fs-sm-4 fs-md-5">How We Make Your Data Work</h1>
              <p class="lead">Put all your data into one place, so you can track performance and discover insights in real-time.</p>
            </div>
          </div>
          <div class="row mt-6">
            <div class="col-lg-4">
              <div class="card card-span h-100">
                <div class="card-span-img"><span class="fa fa-filter fs-4 text-info"></span></div>
                <div class="card-body pt-6 pb-4">
                  <h5 class="mb-2">Integrations</h5>
                  <p>
                    Mix and match metrics from different sources in one Lablytics dashboard and get a more complete view of your performance at a glance.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 mt-6 mt-lg-0">
              <div class="card card-span h-100">
                <div class="card-span-img"><span class="fa fa-chart-bar fs-5 text-success"></span></div>
                <div class="card-body pt-6 pb-4">
                  <h5 class="mb-2">Goals</h5>
                  <p>
                    Track your goals on one screen and visualize your progress toward them on your Lablytics dashboard. 
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 mt-6 mt-lg-0">
              <div class="card card-span h-100">
                <div class="card-span-img"><span class="fa fa-dollar-sign fs-6 text-danger"></span></div>
                <div class="card-body pt-6 pb-4">
                  <h5 class="mb-2">Analyze</h5>
                  <p>Combine your data and easily calculate new metrics, conversion rates, ROI and much more.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="light">
        ...
        <div class="container">
          <div class="row justify-content-center text-center">
            <div class="col-lg-8">
              <p class="fs-3 fs-sm-4 text-white">Let us help you make data-driven decisions about the positioning of your next online campaign.</p>
              <button class="btn btn-outline-light border-2 rounded-pill btn-lg mt-4 fs-0 py-2" type="button">I'm Ready</button>
            </div>
          </div>
        </div>
        <!-- end of .container-->
      ...
      <!-- ============================================-->
      <!-- <section> begin ============================-->
      <section class="bg-light pt-8 pb-4 light">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-4">
              <h5 class="text-uppercase opacity-85 mb-3">Our Mission</h5>
              <p class="text-600">While other organizations talk a good game about being data driven, at LabLytics its in our DNA. We help you craft data-driven strategies that produces fresh, insightful content that offers real value to your consumers.</p>
              <div class="icon-group mt-4"><a class="icon-item bg-white text-facebook" href="https://www.facebook.com/Lablytics-Marketing-100538149002726"><span class="fab fa-facebook-f"></span></a><a class="icon-item bg-white text-twitter" href="https://twitter.com/Lab_Lytics"><span class="fab fa-twitter"></span></a></div>
            </div>
            <div class="col ps-lg-6 ps-xl-8">
              <div class="row mt-5 mt-lg-0">
                <div class="col-6 col-md-3">
                  <h5 class="text-uppercase opacity-85 mb-3">Company</h5>
                  <ul class="list-unstyled">
                    <li class="mb-1"><a class="link-600" href="#!">About</a></li>
                    <li class="mb-1"><a class="link-600" href="#!">Contact</a></li>
                    <li class="mb-1"><a class="link-600" href="#!">The Lab</a></li>
